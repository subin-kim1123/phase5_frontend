...
export default class ArticleContainer extends Component {
    render() {
        return (
            ...
            <div> 
                <h1 style={{fontFamily: 'LucidaStd-bold'}}>Article1</h1>
                <button>Save</button><br/>
                <span style={{fontFamily: 'LucidaStd'}}>Author</span><br/>
                <span style={{fontFamily: 'LucidaStd'}}>Time</span><br/> 
