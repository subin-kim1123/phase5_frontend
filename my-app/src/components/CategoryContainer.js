            ...
            <div>
                <div style={{width: '100%', height: '170px', boxShadow: "10px 5px 5px rgba(0, 0, 0, 0.1)", backgroundColor: "rgba(255, 255, 255,)"}}>
                    ...
                    <div className='category'>
                        <label style={{fontFamily: 'Lucida Std'}}>Money<button onClick={this.handleClick} style={{border: 'none', background: 'none'}}><img src={money} alt="Money" style={{width: '75px'}}/></button></label>
                        <label style={{fontFamily: 'Lucida Std'}}>Film<button style={{border: 'none', background: 'none'}}><img src={film} alt="Film" style={{width: '75px'}}/></button></label>
