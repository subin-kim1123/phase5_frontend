    ...
    render() {
        return (
            <div className="home">
                ...
                <p style={{marginLeft: '500px', marginRight: '500px', lineHeight: '30px', fontFamily: 'LucidaStd', marginBottom: '50px'}}>"Americans spend a lot of time commuting to and from work: about 50 minutes per day, on average, according to the 2017 National Household Travel Survey. This adds up to about 200 hours per year for full-time workers."</p>
                <p style={{marginLeft: '500px', marginRight: '500px', lineHeight: '30px',fontFamily: 'LucidaStd'}}>Commuter is a service that recommends your favorite articles according to the real-time commuting time. To make your commute time as quality time, let's do Commute Better!</p>
